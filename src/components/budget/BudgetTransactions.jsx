...
export default function BudgetTransactions({ config, transactions, setTransactions }) {
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 10 }}>
            {["expense","income","future"].map(t => (
              <button key={t} onClick={() => setForm(f => ({ ...f, type: t }))}
                style={{ flex: 1, padding: "7px 0", borderRadius: "0.375rem", fontSize: 12, fontWeight: form.type === t ? 500 : 400,
